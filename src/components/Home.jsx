            ...
            {isExpanded ? (
                ...
                <div className="condition-summary d-flex justify-content-around w-100" >
                    ...
                    <ConditionOverview
                        ...
                        label="Swell"
                    >
                        <p>{props.swell_direction}<br/>{props.swell}</p>
                    </ConditionOverview>
                    ...
                    <ConditionOverview
                        ...
                        label= "Wind"
                    >
                        <p>{props.wind_direction}<br/>{props.wind}</p>
                    </ConditionOverview>
...
function DateLocationCard(props){
    return(
